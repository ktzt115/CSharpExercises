namespace AssetManager
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            assets[3] = new Car(4, "Toyota", new DateTime(2019, 3, 3), 100000, 2008, 3000);
            assets[4] = new Car(5, "Honda", new DateTime(2010, 3, 3), 100000, 2009, 4000);
            assets[5] = new Car(6, "Suzuki", new DateTime(2015, 3, 3), 100000, 2010, 5000);
